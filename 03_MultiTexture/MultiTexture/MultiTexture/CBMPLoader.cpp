...
/** 装载一个位图文件 */
bool BMPLoader::CLoadBitmap(const std::string file)
{
...
bool BMPLoader::Load(const std::string fileName)
{
	...
	/** 创建纹理 */
	//gluBuild2DMipmaps(GL_TEXTURE_2D, GL_RGB, _mImageWidth, _mImageHeight, GL_RGB, GL_UNSIGNED_BYTE, _pImage);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, _mImageWidth, _mImageHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, _pImage);
