...
void MultiTexture::Draw()
{
	...
	glUniform3f(glGetUniformLocation(_pShaderProgramHandle, "u_light.position"), 0.5f, 0.8f, 0.0f);
	// 设置衰减系数
	...
	glm::mat4 view = glm::lookAt(eyePos /*glm::vec3(1.2f, 1.5f, 4.5f)*/, glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
