...
void MultiTexture::Draw()
{
	...
	// 设置光源属性 
	glUniform3f(glGetUniformLocation(_pShaderProgramHandle, "u_lightPos"), 0.5f, 1.2f, 0.5f);
	...
	glUniform3f(glGetUniformLocation(_pShaderProgramHandle, "u_viewPos"), 0.0f, 0.0f, 4.0f);
	// 投影矩阵
